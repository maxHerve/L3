...
public class PtGen {
	...
	public static void pt(int numGen) {
		...
		// DECLARATION
		case 1:
			placeIdent(UtilLex.numId,VARGLOBALE,ENT,-1);
			afftabSymb();
			break;
		case 2:
			//UtilLex.valNb TODO TODO TODO !!!
			placeIdent(UtilLex.numId,CONSTANTE,,);
			afftabSymb();
			break;
		case 7:
			tCour = ENT;
		...
		default:
			System.out.println("Point de generation "+ numGen +" non prevu dans votre liste");
			break;
